    ...
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 to-black text-white pt-24 pb-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <AnimatedSection as="div" className="text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-4 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">
        ...
        {/* Step-by-step Guide */}
        <AnimatedSection>
          <h2 className="text-3xl font-bold text-center mb-12">Your Journey to Becoming a Prompt Expert</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Understand the Basics</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Master Advanced Techniques</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Apply and Innovate</h3>
        ...
        {/* What is Prompting? */}
        <AnimatedSection>
          <h2 className="text-3xl font-bold text-center mb-12">What is Prompting?</h2>
        ...
        <AnimatedSection>
          <h2 className="text-3xl font-bold text-center mb-12">AI vs. Human Conversation</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
              <h3 className="text-2xl font-semibold text-pink-400 mb-4">Talking to a Human</h3>
              ...
              <p className="text-gray-300 font-mono text-sm mt-4 p-4 bg-gray-900/50 rounded">"Hey, can you suggest a dinner spot? Something not too fancy."</p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
              <h3 className="text-2xl font-semibold text-cyan-400 mb-4">Talking to an AI</h3>
              ...
              <p className="text-gray-300 font-mono text-sm mt-4 p-4 bg-gray-900/50 rounded">"Suggest 3 casual Italian restaurants in San Francisco suitable for a date night, with an average price under $50 per person."</p>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <h2 className="text-3xl font-bold text-center mb-4">Let's Break Down a Prompt</h2>
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-pink-400">The Role: Set the Persona</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-cyan-400">The Task: Define the Goal</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-green-400">The Context: Provide the Details</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-yellow-400">The Constraint: Set the Rules</h4>
